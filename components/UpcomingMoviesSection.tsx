...
import { ChevronLeft, ChevronRight, Zap, Film } from "lucide-react"
    ...
    async function fetchMovies() {
      try {
        const response = await fetch(
          `https://api.themoviedb.org/3/movie/upcoming?api_key=${process.env.NEXT_PUBLIC_TMDB_API_KEY}&page=1`
        )
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#c9a84c] text-xs uppercase tracking-widest font-semibold">Coming Soon</span>
              </div>
              <h2 className="font-display text-2xl font-bold text-[#e8e8e8] mt-0.5">Upcoming Releases</h2>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
