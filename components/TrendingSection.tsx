  ...
  return (
    <section className="py-16 bg-[#080808]">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#c9a84c] text-xs uppercase tracking-widest font-semibold">Trending Now</span>
              </div>
              <h2 className="font-display text-2xl font-bold text-[#e8e8e8] mt-0.5">Most Reviewed</h2>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
        ...
        <div
          ref={scrollRef}
          className="scroll-container flex gap-5 overflow-x-auto pb-4"
        >
          {movies.map((movie) => (
            <Link key={movie.id} href={`/movie/${movie.id}`} className="group flex-shrink-0 w-48">
